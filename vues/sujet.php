                        ...
                        <div class="description">
                            ...
                            <?php if (isset($_SESSION['utilisateur'])) : ?>
                                <div class="actions">
                                    ...
                                    <?php else : ?>
                                        <button class="btn btn-green-light">Résolu</button>
                                    <?php endif; ?>
            ...
            <?php if (count_reponses_by_sujet($_GET['slug']) > 0) : ?>
                <?php foreach (req_reponses_by_sujet($_GET['slug']) as $reponse) : ?>
                    <div class="reponse_sujet">
                        ...
                        <div class="votes">
                            <span class="material-icons good">thumb_up</span>
                            <span>0</span>
                            <span class="material-icons bad">thumb_down</span>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
